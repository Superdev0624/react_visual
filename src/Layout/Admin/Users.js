...
function Users() {
  ...
  return (
    <div className="min-w-screen min-h-screen bg-blue-50 flex justify-center px-5 py-5">
      <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8 bg-blue-50">
        <div className="flex lg:justify-between mb-2 mt-2 bg-blue-50">
          <h2 className="text-3xl text-gray-500 font-medium ml-10 italic ">All Users</h2>
          <input
            type="text"
            className="w-1/3 py-2 border-b-2 border-blue-600 outline-none bg-blue-50 focus:border-yellow-400"
            placeholder="Search..."
          />
          <Link
            to='/createuser'
        ...
        <div className="shadow-slate-900 border border-gray-200 sm:rounded-lg px-2 py-2 mx-5 my-5 bg-blue-50">
