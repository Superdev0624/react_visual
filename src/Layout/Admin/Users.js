...
function Users() {
  ...
  function onDelete(e) {
    const useID = sessionStorage.getItem('UID')
                  ...
                  {usersdata.length > 0 ? (
                     usersdata.map((user, id) =>(
                      ...
                      <td className="px-6 py-4 whitespace-nowrap flex justify-end">
                        ...
                        <button type="button" className="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline" onClick={() => onDelete(id)}>
