    ...
    <div className="min-w-screen min-h-screen flex bg-indigo-50 justify-center px-5 py-5">
      <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
        <div className="flex justify-around ">
          <h2 className="text-5xl text-gray-500 font-medium italic ">User Data</h2>
          <input
            type="text"
            className="w-1/3 py-2 border-b-2 border-blue-600 bg-indigo-50 outline-none text-xl focus:border-yellow-400"
            placeholder="Search..."
          />
          <Link
            to='/createuser'
          ...
          >
            <svg className="h-10 w-12 justify-center items-center"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  strokeWidth="2"  strokeLinecap="round"  strokeLinejoin="round">  
                  ...
                  <tr key={id}>
                    ...
                    <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-center">
                      <div className="flex items-center">
                        <div className="ml-4">
                          <div className="text-xl font-medium text-center text-gray-900">
                            {user.firstname}
                          </div>
